// I found this flappy bird recreation for the DS and i decided to refactor the code to learn something and to just make something cool,
// this file contains the original source code i pretty much replicated, all i did was just split it up into different scripts and go with an OOP approach.
// i hope this might be informative for people who want to up their coding skills and how to potentially refactor code.
// original code below was written by fawnity (thanks G)
...
void DoBackgroundScroll()
{
	...
	NF_ScrollBg(GameScreen, 2, BackGroundxPos, -136); //-136 for full bg, -150 for better game screen size
}
